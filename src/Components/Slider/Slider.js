...
const Slider = () => {
  return (
    <div>
      ...
      <section className="pattern banner-back">
        <div className="geeks">
          <h1 className=" text-5xl font-bold">Amazing company deserve amazing software</h1>
          <h1 className=" text-lg font-semibold">Millions of happy users work better with our integrated Apps.</h1>
          <div>
            <h1>Watch Vedio</h1>
